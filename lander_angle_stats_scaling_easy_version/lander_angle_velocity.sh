...
OUTDIR=/Users/bharathsurianarayanan/Desktop/gymjam/lander_angle_stats_scaling_easy_version
...
do
    python lander_angle_and_velocity.py \
           --sizer-range 2 200 \
           --run-id=ME_lander_angle_velocityBC_scaling_easy_$n \
           --search-type=ME \
           --mode='ME-angleVelocityBC' \
           --init-population-size=1000 \
           --num-individuals=$NUM_INDIVIDUALS \
           --checkpoint-dir=$OUTDIR \
           --checkpoint-prefix=ME_lander_angle_velocityBC_scaling_easy_$n \
           --checkpoint-enabled \
