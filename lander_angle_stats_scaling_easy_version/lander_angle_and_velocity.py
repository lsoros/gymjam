...
RESULTS_OUTPUT_DIR = "/Users/bharathsurianarayanan/Desktop/gymjam/lander_angle_stats_scaling_easy_version/"
...
ME_LANDER_STEPS_BC='ME-landerStepsBC'
ME_LANDER_ANGLE_VELOCITY_BC='ME-angleVelocityBC'
MODES = [ME_ENDPOINT_BC, ME_POLYHASH_BC, ME_FITNESS_BC, ME_ENTROPY_BC,ME_LANDER_STEPS_BC,ME_LANDER_ANGLE_VELOCITY_BC]
...
successful_sequence_list=np.empty(1000,dtype='<U250')
...
class GameEvaluator:
    ...
    def run(self, agent, render=False):
        ...
        if render:
            # env.render()
            rec=VideoRecorder(env,path='/Users/bharathsurianarayanan/Desktop/gymjam/lander_angle_stats_scaling_easy_version/'+str(current_run_id)+'_'+str(current_video_id)+'.mp4')
        ...
        if(current_run%1000==0):
            ...
            # np.savetxt("{}lander_steps_differences_list{}.csv".format(RESULTS_OUTPUT_DIR, current_run_id),lander_steps_differences_list,delimiter=",")
            np.savetxt("/Users/bharathsurianarayanan/Desktop/gymjam/lander_angle_stats_scaling_easy_version/lander_contact_angle_list"+current_run_id+".csv",lander_finish_angle_list,delimiter=",")
            np.savetxt("/Users/bharathsurianarayanan/Desktop/gymjam/lander_angle_stats_scaling_easy_version/lander_contact_resultant_velocity_list"+current_run_id+".csv",lander_finish_velocity_list,delimiter=",")
            # np.savetxt("lan")
        ...
        elif self.mode == ME_LANDER_STEPS_BC:
            # print('in lander steps BC mode')
...
def runME(run_id, game, sequence_len,
    ...
    elif mode == ME_LANDER_STEPS_BC:
        # print('using ME_LANDER_ANGLE_VELOCITY_BC')
        # print('using lander steps BC')
    ...
    for individuals_evaluated in range(num_individuals):
        ...
        if cur_agent.fitness >= 200:
            ...
            successfull_sequence = cur_agent.commands
            successfull_sequence_string = '/'.join(map(str, cur_agent.commands)) 

            successful_sequence_list[current_video_id] = successfull_sequence_string
    ...
    with open('{}best_fitness_{}.txt'.format(RESULTS_OUTPUT_DIR, run_id), 'w') as filehandle:
    ...
    np.savetxt("{}successful_fitnesses{}.csv".format(RESULTS_OUTPUT_DIR, current_run_id),successful_fitness_list, delimiter=",")
    np.savetxt("{}successful_seqeunces{}.csv".format(RESULTS_OUTPUT_DIR,current_run_id),successful_sequence_list, delimiter=",",fmt="%s")
