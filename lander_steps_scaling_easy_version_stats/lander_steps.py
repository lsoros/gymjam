...
RESULTS_OUTPUT_DIR = "/Users/bharathsurianarayanan/Desktop/gymjam/lander_steps_scaling_easy_version_stats/"
...
class GameEvaluator:
    ...
    def run(self, agent, render=False):
        ...
        if render:
            # env.render()
            rec=VideoRecorder(env,path='/Users/bharathsurianarayanan/Desktop/gymjam/lander_steps_scaling_easy_version_stats/'+str(current_run_id)+'_'+str(current_video_id)+'.mp4')
