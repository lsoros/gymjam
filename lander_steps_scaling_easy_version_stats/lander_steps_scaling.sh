...
OUTDIR=/Users/bharathsurianarayanan/Desktop/gymjam/lander_steps_scaling_easy_version_stats
...
for n in {20..20}
do
    python lander_steps.py \
           --sizer-range 2 200 \
           --run-id=ME_lander_stepsBC_scaling_$n \
           --search-type=ME \
           --mode='ME-landerStepsBC' \
           --init-population-size=1000 \
           --num-individuals=$NUM_INDIVIDUALS \
           --checkpoint-dir=$OUTDIR \
           --checkpoint-prefix=ME_lander_stepsBC_scaling_$n \
           --checkpoint-enabled \
