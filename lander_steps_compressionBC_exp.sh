...
OUTDIR=/Users/bharathsurianarayanan/Desktop/gymjam/lander_steps_zlibcompressionBC_stats
...
for n in {1..20}
do
    python lunar_lander_compressionBC.py \
           --run-id=comppressionBC1_$n \
           --search-type=ME \
           --mode='ME-endpointBC' \
           --init-population-size=1000 \
           --num-individuals=$NUM_INDIVIDUALS \
           --checkpoint-dir=$OUTDIR \
           --checkpoint-prefix=compressionBC_$n \
           --checkpoint-enabled \
